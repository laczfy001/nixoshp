...
static const Bool systrayonleft = False;
static const Bool systrayspacing = True;
...
static const char *screengrabcmd[] = { "screengrab", NULL  };

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = alacrittycmd } },
	{ MODKEY,			XK_c, 	   spawn,		   {.v = screengrabcmd } },
